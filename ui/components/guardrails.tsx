...
export function Guardrails({ guardrails, inputGuardrails }: GuardrailsProps) {
  ...
  const guardrailDescriptionMap: Record<string, string> = {
    "Goal Validation Guardrail": "Validate health goal format (quantity, metric, duration)",
    "Health Relevance Guardrail":
      "Ensure messages are relevant to health, fitness, and wellness topics",
  };
  ...
  return (
    <PanelSection
      title="Health & Wellness Guardrails"
